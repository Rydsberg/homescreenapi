 ...
 * @export
 * @interface VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel
 */
export interface VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel {
    /**
     * 
     * @type {VTApiPlaneraResaCoreModelsTransportMode}
     * @memberof VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel
     */
...
/**
 * Check if a given object implements the VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel interface.
 */
export function instanceOfVTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModelFromJSON(json: any): VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel {
    return VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModelFromJSONTyped(json, false);
}

export function VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel {
...
export function VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModelToJSON(value?: VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
